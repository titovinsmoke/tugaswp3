<div class="container-fluid">
	...
	<table class="table table-striped table-bordered" style="margin-bottom: 100px">
		<tr>
			...
			<th class="text-center">Setatus</th>
			...
			<tr>
				...
				<td>
					<center>
						...
						<a onclick="return confirm('Apakah Anda Yakin Hapus !!!')" class="btn btn-sm btn-danger" href="<?php echo base_url('admin/dataPegawai/deleteData/' . $p->id_pegawai) ?>"><i class="fas fa-trash"></i></a>
					</center>
				</td>
			</tr>
		<?php endforeach; ?>
