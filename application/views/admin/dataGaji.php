<div class="container-fluid">
	...
	<div class="card mb-3">
		...
		<div class="card-body">
			<form class="form-inline">
				...
				<?php } else { ?>
					<button type="button" class="btn btn-success mb-2 ml-3" data-toggle="modal" data-target="#exampleModal"><i class="fas fa-print"></i> Cetak Daftar Gaji</button>
				<?php } ?>
	...
	if ($jml_data > 0) { ?>
		...
		<div class="table-responsive">
			<table class="table table-borderred table-striped" style="margin-bottom: 100px">
				<tr>
		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<div class="modal-body">
					Data Gaji Masih Kosong, Silah kan input Absensi Terlebih Dahulu Pada bulan dan tahun yang anda pilih!!!
				</div>
